...
.ds-tablet-falling {
  width: 2.92%;
  height: 2.4%;
  z-index: 6;                        /* above chamber filled water (z=4) */
  pointer-events: none;
}
...
/* RPM display overlay on the screen */
.ds-rpm-display {
  position: absolute;
  left: 23.38%;
  top:  17.6%;
...
/* Time display overlay
   Bounds (207,184)→(351,212); center (279, 198); size 144×28
     → 23.25%, 26.4%; 12% × 3.73% */
.ds-time-display {
  position: absolute;
  left: 23.25%;
...
/* ══ STEP 7: PADDLE ══
   Paddle PNG: 50×32. Pivot is top-center at (348, 407) on bg. */
.ds-paddle {
  position: absolute;
  left: 26.92%;
  top:  54.27%;
...
/* Rack hotspot (rack stays in bg)
   Bounds (962,319) → (1183,514); center (1072.5, 416.5)
     → 89.4%, 55.5%; 18.42% × 26% */
.ds-rack-hotspot {
  position: absolute;
  left: 89.4%;
...
<div class="modal-overlay" id="modalDissolution">
  <div class="lab-modal" style="max-width:1100px; max-height:96vh;">
    ...
    <div class="lab-modal-body" style="padding:10px 22px 22px;">
      ...
      <div class="ds-scene" id="dsScene">
        ...
        <img src="/Assets/VirtualLab/dissolution_bg.png"
        ...
        <div class="ds-obj ds-chamber-filled" id="dsChamberFilled">
          <img src="/Assets/VirtualLab/chamber_filled.png" alt="">
        </div>
        ...
        <div class="ds-obj ds-vol" id="dsVolFlask">
          ...
          <img class="ds-vol-img" src="/Assets/VirtualLab/volumetric_flask.png" alt="">
        ...
        <div class="ds-obj ds-round"
          ...
          <img class="ds-round-liquid"  id="dsRoundLiquidImg"
               src="/Assets/VirtualLab/round_flask_liquid.png"  alt="">
          <img class="ds-round-outline" id="dsRoundOutlineImg"
               src="/Assets/VirtualLab/round_flask_outline.png" alt="">
          <div class="ds-round-pulse"></div>
          <div class="ds-round-pulse delay"></div>
        </div>

        <!-- Tablet container — closed -->
        <div class="ds-obj ds-tablet" id="dsTabletContainer"
             onclick="dsOpenContainer()"
             title="Tablet container">
          <img src="/Assets/VirtualLab/tablet_container.png" alt="Tablet container"
               id="dsTabletContainerClosed">
          <img src="/Assets/VirtualLab/tablet_container_open.png" alt="Tablet container (open)"
        ...
        <div class="ds-obj ds-tablet-draggable" id="dsTabletDraggable"
             ...
             style="display:none;">
          <img src="/Assets/VirtualLab/tablet.png" alt="Tablet">
        </div>

        <!-- Falling tablet (hidden until placed in chamber) -->
        <div class="ds-obj ds-tablet-falling" id="dsTabletFalling" style="display:none;">
          <img src="/Assets/VirtualLab/tablet.png" alt="">
        </div>

        <!-- Tablet drop zone over the chamber -->
        ...
        <!-- ════════ HOTSPOT: TIME KNOB  ════════
             Bounds (214,225) → (235,250); center (224.5, 237.5); size 21×25 -->
        ...
        <!-- ════════ PADDLE ════════
             Pivot point on bg: (348, 407).
             PNG dimensions: 50×32 -->
        <div class="ds-paddle" id="dsPaddle">
          <img src="/Assets/VirtualLab/paddle.png" alt="Paddle" draggable="false">
        </div>

        <!-- ════════ HOTSPOT: START BUTTON ════════ -->
        ...
        <!-- ════════ STEP 8: PIPETTE RACK + PIPETTE + FILTER ════════ -->
        <!-- Rack hotspot (rack itself stays in bg, hotspot is a clickable area) -->
        ...
        <div class="ds-pipette" id="dsPipette" style="display:none;"
          ...
          <img class="ds-pipette-liquid"  id="dsPipetteLiquid"
               src="/Assets/VirtualLab/pipette_liquid.png"  alt="" draggable="false">
          <img class="ds-pipette-outline" src="/Assets/VirtualLab/pipette_outline.png" alt="Pipette" draggable="false">
        </div>

        <!-- Pipette drop zone over chamber -->
        ...
        <!-- Filter (empty + filled overlay)
             Center (553, 486); PNG dimensions 60×80 -->
        <div class="ds-filter">
          <img class="ds-filter-empty"  id="dsFilterEmpty"
               src="/Assets/VirtualLab/filter_empty.png"  alt="Filter">
          <img class="ds-filter-empty"  id="dsBeakerOnly"
               src="/Assets/VirtualLab/beaker_only.png" alt=""
               style="display:none;">
          <!-- Filled state with funnel still on (initial pour animation) -->
          <img class="ds-filter-filled" id="dsFilterFilled"
               src="/Assets/VirtualLab/filter_filled.png" alt="">
          <!-- Water-only state (after funnel removed) -->
          <img class="ds-filter-filled" id="dsFilterWaterOnly"
               src="/Assets/VirtualLab/filter_water_only.png" alt=""
               style="display:none;">
        </div>

        <!-- ════════ SAMPLE CUVETTE ════════
             Bottom at (730, 514), so center = (730, 434)
             PNG dimensions: 80×160 -->
        <div class="ds-cuvette ds-cuvette-sample" id="dsSampleCuvette">
          <img class="ds-cuvette-empty" src="/Assets/VirtualLab/sample_cuvette_empty.png" alt="Sample Cuvette">
          <img class="ds-cuvette-filled" id="dsSampleCuvetteFilled"
               src="/Assets/VirtualLab/sample_cuvette_filled.png" alt="">
        </div>

        <!-- ════════ BLANK CUVETTE ════════
             Bottom at (637, 530), so center = (637, 450) -->
        <div class="ds-cuvette ds-cuvette-blank" id="dsBlankCuvette">
          <img class="ds-cuvette-empty" src="/Assets/VirtualLab/sample_cuvette_empty.png" alt="Blank Cuvette">
        ...
        <!-- Pipette drop zone over sample cuvette -->
        ...
        <!-- Pipette drop zone over volumetric flask -->
        ...
        <!-- Pipette drop zone over blank cuvette -->
...
function dsClickRack() {
  ...
  if (dsPipette2Done && !dsPipette3Done) {
    ...
    document.getElementById('dsSceneBg').src = '/Assets/VirtualLab/dissolution_bg_0.png';
  ...
  if (dsPipette1Done && !dsPipette2Done) {
    ...
    document.getElementById('dsSceneBg').src = '/Assets/VirtualLab/dissolution_bg_1.png';
  ...
  document.getElementById('dsSceneBg').src = '/Assets/VirtualLab/dissolution_bg_2.png';
...
window.addEventListener('labResetDissolution', () => {
  ...
  if (sceneBg) sceneBg.src = '/Assets/VirtualLab/dissolution_bg.png';
